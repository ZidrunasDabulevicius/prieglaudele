...
$query= mysqli_query($link, "select kategorija.pavadinimas as pavadinimas, gyvunai.amzius as amzius, gyvunai.nuotrauka as nuotrauka, gyvunai.vardas as vardas, gyvunai.aprasas as aprasas, pavadinimas from gyvunai,kategorija WHERE gyvunai.kategorija_id=kategorija.kategorija_id and pavadinimas='kiti';");
